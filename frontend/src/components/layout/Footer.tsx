      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            <li><Link to="/dashboard/resume" className="text-sm text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">AI Resume Builder</Link></li>
            <li><Link to="/dashboard/ats" className="text-sm text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">ATS Score Checker</Link></li>
            <li><Link to="/dashboard/interview" className="text-sm text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">AI Mock Interviews</Link></li>
            <li><Link to="/dashboard/portfolio" className="text-sm text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">Portfolio Generator</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            <li><Link to="/pricing" className="text-sm text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">Pricing Plans</Link></li>
            <li><a href="#" className="text-sm text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">Terms of Service</a></li>
            <li><a href="#" className="text-slate-500 hover:text-brand-500 dark:text-slate-400 transition">Privacy Policy</a></li>
