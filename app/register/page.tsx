...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 relative z-10">
      <motion.div
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Get started with CareerAI Pro for free
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-slate-750 dark:text-slate-300 mb-1.5">
                Full Name
              </label>
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 rounded-2xl bg-gradient-to-r from-brand-600 to-indigo-600 text-white font-medium text-sm flex items-center justify-center space-x-2 shadow-lg shadow-brand-500/10 hover:shadow-brand-500/20 active:scale-98 transition disabled:opacity-70 disabled:pointer-events-none"
            >
              {loading ? (
