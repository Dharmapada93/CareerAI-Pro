    ...
    <div className="relative z-10 pb-16 max-w-4xl mx-auto text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="glass-panel p-5 rounded-3xl flex items-center justify-between">
          ...
          <div className="p-3 rounded-2xl bg-brand-500/10 text-brand-605">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="md:col-span-2 glass-panel p-6 sm:p-8 rounded-3xl">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-2xl border border-slate-200/50 dark:border-slate-800/40 glass-input text-xs text-slate-450 dark:text-slate-500 bg-slate-100/50 dark:bg-slate-900/30 cursor-not-allowed"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="glass-panel p-6 rounded-3xl text-left space-y-4">
          ...
          <div className="p-5 rounded-2xl bg-brand-500/5 border border-brand-500/10 space-y-4">
            ...
            <Link
              href="/pricing"
              className="block text-center w-full py-2.5 px-4 rounded-xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 hover:text-white dark:hover:bg-slate-700 text-white text-xs font-bold transition"
            >
              Manage Subscription
            </Link>
          </div>
