          ...
          <div className="glass-panel p-6 rounded-3xl space-y-4">
            ...
            <div className="flex items-center justify-between p-4.5 bg-slate-50/50 dark:bg-slate-900/30 border border-slate-200/30 dark:border-slate-800/30 rounded-2xl">
              ...
              <button
                type="button"
                onClick={toggleTheme}
                className="p-3 rounded-2xl border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800/40 text-slate-500 transition flex items-center"
              >
                {theme === "dark" ? (
          ...
          <div className="glass-panel p-6 rounded-3xl space-y-5">
            ...
            <div className="space-y-4.5">
              ...
              <div className="space-y-1.5 pt-2 border-t border-slate-100 dark:border-slate-800/30">
                ...
                <p className="text-[10px] text-slate-450 dark:text-slate-500 mb-2 leading-relaxed">
        ...
        <div className="glass-panel p-6 rounded-3xl space-y-5">
          ...
          <div className="pt-6 border-t border-slate-100 dark:border-slate-800/40">
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-brand-600 to-indigo-650 text-white font-bold text-xs flex items-center justify-center space-x-1.5 shadow-md shadow-brand-500/10 hover:shadow-brand-500/20 active:scale-95 transition"
            >
