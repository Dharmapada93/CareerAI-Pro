...
// Inline LinkedIn Icon replacement to prevent dependency barrel resolution conflicts
  ...
  return (
    <div className="relative z-10 pb-16 text-slate-800 dark:text-slate-100 max-w-6xl mx-auto px-4">
      ...
      <div className="mb-10 text-left">
        <h1 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-brand-650 to-indigo-600 bg-clip-text text-transparent dark:from-brand-400 dark:to-indigo-405 flex items-center space-x-2">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4.5 py-2.5 rounded-2xl text-xs font-bold transition-all ${
                activeTab === tab.id
                  ...
                  : "bg-slate-100 hover:bg-slate-200/80 text-slate-600 dark:bg-slate-800/45 dark:text-slate-350 dark:hover:bg-slate-800"
              }`}
            >
          ...
          <AnimatePresence mode="wait">
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="px-3 rounded-xl bg-slate-905 text-white dark:bg-slate-800 dark:hover:bg-slate-700 text-xs font-semibold"
                    >
                      Add
                    </button>
                  </div>
                  <div className="flex flex-wrap gap-1.5 mt-2.5">
                    {currentSkills.map((sk, i) => (
                      <span key={i} className="inline-flex items-center space-x-1 px-2.5 py-0.5 rounded-md bg-brand-500/10 text-brand-700 dark:text-brand-400 text-[10px] font-bold">
                        <span>{sk}</span>
            ...
            {activeTab === "learning" && (
              <motion.form
                ...
                className="space-y-4 text-left"
              >
                <h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-2">Learning Plan Config</h3>
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Missing Technologies / Gaps</label>
                  <div className="flex space-x-2">
                    <input
                      type="text"
            ...
            {activeTab === "linkedin" && (
              ...
              >
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Target Job Role</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Core Competencies</label>
                  <div className="flex space-x-2">
                    <input
                      type="text"
            ...
            {activeTab === "negotiation" && (
              ...
              >
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Job Role</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Offer Details</label>
                  <textarea
                    rows={4}
            ...
            {activeTab === "outreach" && (
              ...
              >
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Target Company</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Target Role</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase mb-1.5">Additional Context / Details</label>
                  <textarea
                    rows={3}
                ...
                {roadmapResult ? (
                  <div className="space-y-6">
                    ...
                    <div className="glass-panel p-6 sm:p-8 rounded-3xl relative overflow-hidden">
                      ...
                      <div className="relative border-l-2 border-slate-205 dark:border-slate-800 ml-4 space-y-8 pb-4">
                          ...
                          <div key={idx} className="relative pl-8 group">
                            ...
                            <div className="space-y-1">
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                                <h4 className="text-sm font-bold text-slate-905 dark:text-slate-100 group-hover:text-brand-600 dark:group-hover:text-brand-405 transition-colors">
                                  {milestone.title}
                                </h4>
                  ...
                  <div className="glass-panel p-10 text-center rounded-3xl text-slate-400 space-y-3">
                        ...
                        {learningPlanResult.modules.map((mod, idx) => (
                          <div key={idx} className="p-5 rounded-2xl bg-slate-50/50 dark:bg-slate-900/40 border border-slate-200/40 dark:border-slate-800/40 space-y-4">
                            <div className="flex justify-between items-start">
                              <h4 className="text-xs font-bold text-slate-900 dark:text-white uppercase leading-snug tracking-wide max-w-[70%]">
                                {mod.title}
                              </h4>
                              <span className="text-[9px] font-bold bg-purple-500/10 text-purple-700 dark:text-purple-300 px-2 py-0.5 rounded">
                                {mod.duration}
                              </span>
                            </div>

                            <div className="space-y-1.5">
                              <p className="text-[10px] font-bold text-slate-400 uppercase">Core Topics</p>
                              <ul className="list-disc pl-4 text-xs text-slate-500 dark:text-slate-400 space-y-0.5">
                            ...
                            {mod.resources && mod.resources.length > 0 && (
                              <div className="pt-3 border-t border-slate-100 dark:border-slate-800/40 space-y-1">
                ...
                {linkedinResult.length > 0 ? (
                  <div className="space-y-4">
                    {linkedinResult.map((bio, idx) => (
                      <div key={idx} className="glass-panel p-5 rounded-2xl flex justify-between items-start gap-4">
                        <div className="space-y-1.5 flex-grow">
                          <span className="text-[9px] font-bold bg-blue-500/10 text-blue-700 dark:text-blue-450 px-2 py-0.5 rounded">
                            BIO VARIANT {idx + 1}
                          </span>
                          <p className="text-xs leading-relaxed text-slate-700 dark:text-slate-205 pr-2">
                            {bio}
                          </p>
                        </div>
                        ...
                        <button
                          ...
                          className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-105 dark:hover:bg-slate-800/40 text-slate-500 transition flex-shrink-0"
                  ...
                  <div className="glass-panel p-10 text-center rounded-3xl text-slate-400 space-y-3">
                    ...
                    <p className="text-xs">Insert target roles and details to craft 3 premium high-conversion headlines for your LinkedIn summary.</p>
                  </div>
                )}
              </motion.div>
            )}
            ...
            {!loading && activeTab === "negotiation" && (
              ...
              >
                {negResult ? (
                  <div className="space-y-6">
                    {/* Strategy summary */}
                    <div className="glass-panel p-5 rounded-2xl bg-amber-500/[0.02] border-amber-500/10 border space-y-2">
                      <div className="flex items-center space-x-2 text-amber-600 dark:text-amber-400">
                        <AlertCircle className="w-4 h-4" />
                        <h4 className="text-xs font-bold uppercase tracking-wider">Strategic Recommendation</h4>
                      </div>
                      <p className="text-xs leading-relaxed text-slate-655 dark:text-slate-300">
                        {negResult.strategy}
                      </p>
                    </div>
                    ...
                    <div className="glass-panel p-6 sm:p-8 rounded-3xl space-y-6">
                      ...
                      <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800/40">
                        ...
                        {negResult.scripts.map((script, idx) => (
                          <div key={idx} className="p-4.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/40 dark:border-slate-800/30 space-y-3">
                            <div className="flex justify-between items-center">
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800/50 text-slate-500 transition"
                                title="Copy dialogue"
                              >
              ...
              >
                {outreachResult ? (
                  <div className="glass-panel p-6 sm:p-8 rounded-3xl space-y-4 relative">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800/55 text-slate-500 flex items-center space-x-1.5 transition text-xs font-bold"
                      >
                    ...
                    <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/40 dark:border-slate-800/30">
                  ...
                  <div className="glass-panel p-10 text-center rounded-3xl text-slate-400 space-y-3">
                    ...
                    <p className="text-xs">Paste target role and target company parameters to write clean recruiter inquiry templates.</p>
                  </div>
                )}
              </motion.div>
            )}
